...
Module MOD_FILEINFO
  ...
  !UNIT_HIS
!
      Character (Len=24) :: CNAME (34)!Wen Long this should be moved to wqm_alg.F and also wqm_alg and wqm_kin should be
...
Contains
  ...
  !
    ...
    !
         ...
         CNAME (33) = 'Dissolved Inorganic Carbon' !LB
         CNAME (34) = 'Total Alkalinity' !LB
    !CNAME(35) =  'pH'    							 !LB
    !CNAME(36) =  'Seawater pCO2'    					 !LB
!
         Return
