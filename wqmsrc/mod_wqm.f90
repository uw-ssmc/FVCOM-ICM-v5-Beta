...
!
 ...
 REAL (SP) :: PTC_SD, PTC_WC,SED_DEN,DFFCOEFS12,BRLVEL,TxcSdmUnfm,CnbToDWLZ, LipidFracLZ
 REAL (SP) :: HNRCFF, KuptkSZ, KuptkLZ, KowPCB, GrwthSZ, GrwthLZ,CnbToDWSZ, LipidFracSZ
