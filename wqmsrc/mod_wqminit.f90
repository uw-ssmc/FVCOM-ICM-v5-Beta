...
Module MOD_WQMINIT
  ...
  !
     ...
     & SILICA_CALC, CBN_IMPACT_BIO
  !
      Logical :: LEFT_FLOWB (NHQP), RIGHT_FLOWB (NHQP), LEFTM1_BOUNDARY &
     & (NHQP), RIGHTP1_BOUNDARY (NHQP)
  !
      Logical :: IS_ATM_FCO2, CARBONATE_CALC !LB
  !      Logical :: SAVE_PH_OUTPUT, SAVE_PCO2_OUTPUT  !LB
  !
...
!
      ...
      Real (SP) :: OINT (NOIP)
      Character (Len=3), DIMENSION(:), ALLOCATABLE :: ACC
  !
      Real (SP), DIMENSION(:), ALLOCATABLE :: CIC , COUT
  !
