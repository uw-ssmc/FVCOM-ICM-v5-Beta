...
!
    ...
    !
       ...
       !                                    ----------------------------------------------------------------------------------------
       !Wen Long                           !*** the unit of xflux_obc should be [m][m/s][concentration]  i.e. [m^2/s][concentration]
       !                                   !    where concentration could be for dye, deg-C for temperature, psu for salinity
       !                                   !    FVCOM is not clear on what unit xflux_obc has, but the calculation gives (velocity *
       !
         Else
       !
