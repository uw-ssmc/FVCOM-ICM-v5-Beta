...
MODULE TXC_KNT
  ...
  USE MOD_WQM, ONLY: SSI, C1, C2, POC_CONCENS, DOC_CONCENS, WMS, TxcOutVar, NumTxcOutVar, TxcOutput, &
                    ...
                    & VDiffCoff, KDecay,ExcLossSZ,ExcLossLZ,PcbCon_AlgW1,PcbCon_AlgW2
...
!----------------- Toxics concentrations in each constituents--------------------------------------------------
          ...
          PcbCon_AlgW = 0.0
          ALLOCATE(PcbCon_AlgW1(0:MTLOC,KBM1,NTXVB))
          PcbCon_AlgW1 = 0.0
          ALLOCATE(PcbCon_AlgW2(0:MTLOC,KBM1,NTXVB))
          PcbCon_AlgW2 = 0.0
...
SUBROUTINE ExtractTxcData
 ...
 PcbCon_AlgW1 = FP_BOC1_W * CONPCB_W
 PcbCon_AlgW2 = FP_BOC2_W * CONPCB_W
