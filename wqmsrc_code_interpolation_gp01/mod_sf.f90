...
!
    ...
    !
       ...
       !
           ...
           & (FILTCT*SF(I)*B1ASF) / (D(I)*DZ(KBM1)) / 1000. / 86400. ! units: g/m3/s
       !
            DTPIB2 (I, KBM1) = DTPIB2 (I, KBM1) - Q2 (I, KBM1) * &
           & (FILTCT*SF(I)*B2ASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTPIB3 (I, KBM1) = DTPIB3 (I, KBM1) - Q3 (I, KBM1) * &
           & (FILTCT*SF(I)*B3ASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTLPOC (I, KBM1) = DTLPOC (I, KBM1) - &
           & (FILTCT*SF(I)*LPOCASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTLPOP (I, KBM1) = DTLPOP (I, KBM1) - &
           & (FILTCT*SF(I)*LPOPASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTLPON (I, KBM1) = DTLPON (I, KBM1) - &
           & (FILTCT*SF(I)*LPONASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTRPOC (I, KBM1) = DTRPOC (I, KBM1) - &
           & (FILTCT*SF(I)*RPOCASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTRPOP (I, KBM1) = DTRPOP (I, KBM1) - &
           & (FILTCT*SF(I)*RPOPASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
            DTRPON (I, KBM1) = DTRPON (I, KBM1) - &
           & (FILTCT*SF(I)*RPONASF) / (D(I)*DZ(KBM1)) / 1000. / 86400.
       !
       ...
       !
           ...
           & (D(I)*DZ(KBM1)) / 1000. / 86400. !Wen Long: Sign should be negative?
