...
Contains
  ...
  !
    ...
    !
         ...
         Read (AGR, 1030) FNIP, FNUP, FNLDP, FNRDP, FNLPP, FNRPP !need to add up to 1, FNUP not used at all
    ...
    !
         ...
         Read (AGR, 1030) FNI1, FNLD1, FNRD1, FNLP1, FNRP1 !WLong: should check if they add up to 1 after reading
    ...
    !
         Do K = 1, KBM1
          ...
          !
              ...
              & KTG21)!!LB: replace FT1(ITEMP)-lookup-table with "get_FT1(T)" -NOW get_FT(T,TMP,KTG1,KTG2)
          ...
          !
              ...
              & GET_FTPR (T(I, K), TRPR, KTPR) * TVPR (J)!gC/m^3/day ??  !Laura: should not repeat B1	
    ...
    !
         Do K = 2, KBM1
          ...
          ! 14 SEPT 2009 - KURT GLAESEMANN CHANGED X/Y/86400 TO X/(Y*86400)
              ...
              & K-1)-WS1(I, K)*B1(I, K)) / (D(I)*DZ(K)*86400.)
               DTB2 (I, K) = DTB2 (I, K) + (WS2(I, K-1)*B2(I, &
              & K-1)-WS2(I, K)*B2(I, K)) / (D(I)*DZ(K)*86400.)
               DTB3 (I, K) = DTB3 (I, K) + (WS3(I, K-1)*B3(I, &
              & K-1)-WS3(I, K)*B3(I, K)) / (D(I)*DZ(K)*86400.)
            End Do
         End Do
    !   DO K=2,KBM1
    !     DO I=1,MLOC
