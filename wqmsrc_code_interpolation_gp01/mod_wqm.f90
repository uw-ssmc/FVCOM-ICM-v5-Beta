Module MOD_WQM
  ...
  !
     ...
     & PIB1, PIB2, PIB3, DIC, TALK, pH, pCO2
  !
  ...
  !DIC,  & !33 Dissolved inorg carbon (mmolC/m^3)    					   !LB
...
!
  ...
  !
      Real (SP) :: I0, IT, ITNX, ISMIN !NOT used in the code
  !
...
!
  ...
  ! KURT GLAESEMANN add C2_GL
      ...
      Real (SP), Allocatable, Dimension (:) :: TTL_MASS, TTL_MASS_GL
...
!
  ...
  !
  !
      Real (SP), Allocatable, Dimension (:, :) :: PM1, PM2, PM3, BMR1, &
     & BMR2, BMR3, BPR1, BPR2, BPR3, CCHL1, CCHL2, CCHL3, Q1, Q2, Q3 !Phosphorus to Carbon ratio (gP/gC) for algal group 3
  !
  !
...
!
  ...
  !
      Real (SP), Save :: ELTMSPLT, ELTMSTFL, ELTMSKFL, EPI
  !
...
!
         If (ALLOCATED(DIC)) DEALLOCATE (DIC)!LB
