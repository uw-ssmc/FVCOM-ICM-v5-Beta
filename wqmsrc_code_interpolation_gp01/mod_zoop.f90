...
!
  ...
  !
    ...
    !temperature control of micro-zooplankton
         Real (SP) :: TMSZ, KTGSZ1, KTGSZ2, TRPRSZ, KTPRSZ !shape coef of temperature curve for micro-zoop predation rate (1/degC)
    !
    !temperature control of meso-zooplankton
         Real (SP) :: TMLZ, KTGLZ1, KTGLZ2, TRPRLZ, KTPRLZ !shape coef of temperature curve for meso-zoop predation rate (1/degC)
    !
