...
Contains
  ...
  !
    ...
    !
         Do I = 1, MLOC
			IF(D(I) > 0.0_SP)THEN
				DTT (I, 1) = KT / (RHO_*CP*D(I)*DZ(1)) * (TE-T(I, 1))
			ELSE
				DTT(I,1)=0.0_SP
			ENDIF
         End Do
    ...
    !
       ...
       !
            Do I = 1, MLOC
              ...
              & KBM1)-WSSNET(I)) * SSI (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
         ...
         Do K = 1, KBM1
          ...
          !
              ...
              & K)/(RPOC(I, K)+1.0E-30)) / (PRASZ(I, K)+1.0E-30)
               NRRATE = ((ANCPSZ-ANCSZ*ESZ(I, K)*(1.-RFSZ(I, &
          ...
          !
              ...
              & K)+1.0E-30)) / (PRALZ(I, K)+1.0E-30)
               NRRATE = ((ANCPLZ-ANCLZ*ELZ(I, K)*(1.-RFLZ(I, &
    ...
    !
       ...
       !
            Do I = 1, MLOC
              ...
              & KBM1)-WSLNET(I)) * LPOC (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
               DTRPOC (I, KBM1) = DTRPOC (I, KBM1) + (WSR(I, &
              & KBM1)-WSRNET(I)) * RPOC (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
            End Do
         End If
    !
    ...
    !
         If (SAV_CALC) Then
            Do I = 1, NSAVCELL
              ...
              & (LDOCSAVW(B)+LDOCEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRDOC (B, KBM1) = DTRDOC (B, KBM1) + &
              & (RDOCSAVW(B)+RDOCEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTLPOC (B, KBM1) = DTLPOC (B, KBM1) + &
              & (LPOCSAVW(B)+LPOCEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRPOC (B, KBM1) = DTRPOC (B, KBM1) + &
              & (RPOCSAVW(B)+RPOCEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
            End Do
         End If
    !
    !
    ...
    !
       ...
       !
            Do I = 1, MLOC
              ...
              & KBM1)-WSLNET(I)) * LPON (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
               DTRPON (I, KBM1) = DTRPON (I, KBM1) + (WSR(I, &
              & KBM1)-WSRNET(I)) * RPON (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
            End Do
         End If
    !
    ...
    !
         If (SAV_CALC) Then
            Do I = 1, NSAVCELL
              ...
              & (NH4SAVW(B)+NH4EPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTNO3 (B, KBM1) = DTNO3 (B, KBM1) + &
              & (NO3SAVW(B)+NO3EPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTLDON (B, KBM1) = DTLDON (B, KBM1) + &
              & (LDONSAVW(B)+LDONEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRDON (B, KBM1) = DTRDON (B, KBM1) + &
              & (RDONSAVW(B)+RDONEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTLPON (B, KBM1) = DTLPON (B, KBM1) + &
              & (LPONSAVW(B)+LPONEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRPON (B, KBM1) = DTRPON (B, KBM1) + &
              & (RPONSAVW(B)+RPONEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
            End Do
         End If
    !
    !******* Atmospheric Loads
    ...
    !
         Do K = 2, KBM1
          ...
          !
              ...
              & K)*PIB3(I, K)) * V2 (I, K) / (D(I)*DZ(K)*86400.)
          !
            End Do
         End Do
    !
    ...
    !
       ...
       !
            Do I = 1, MLOC
              ...
              & KBM1)-WSSNET(I)) * PP / (D(I)*DZ(KBM1)) / 86400.
               DTLPOP (I, KBM1) = DTLPOP (I, KBM1) + (WSL(I, &
              & KBM1)-WSLNET(I)) * LPOP (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
               DTRPOP (I, KBM1) = DTRPOP (I, KBM1) + (WSR(I, &
              & KBM1)-WSRNET(I)) * RPOP (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
               DTPIB1 (I, KBM1) = DTPIB1 (I, KBM1) + (WS1(I, &
              & KBM1)-WS1NET(I)) * PIB1 (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
               DTPIB2 (I, KBM1) = DTPIB2 (I, KBM1) + (WS2(I, &
              & KBM1)-WS2NET(I)) * PIB2 (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
    ...
    !
         If (SAV_CALC) Then
          ...
          !
              ...
              & (PO4SAVW(B)+PO4EPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTLDOP (B, KBM1) = DTLDOP (B, KBM1) + &
              & (LDOPSAVW(B)+LDOPEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRDOP (B, KBM1) = DTRDOP (B, KBM1) + &
              & (RDOPSAVW(B)+RDOPEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTLPOP (B, KBM1) = DTLPOP (B, KBM1) + &
              & (LPOPSAVW(B)+LPOPEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
               DTRPOP (B, KBM1) = DTRPOP (B, KBM1) + &
              & (RPOPSAVW(B)+RPOPEPIW(B)) / (D(B)*DZ(KBM1)) / 86400.
            End Do
         End If
    !
    !******* Atmospheric loads
    ...
    !
       ...
       !******  Settling
            Do I = 1, MLOC
              ...
              & (D(I)*DZ(1)*86400.)!WLong, we need to work on V2
       ...
       !
            If (SEDIMENT_CALC) Then
               Do I = 1, MLOC
                 ...
                 & KBM1)-WSSNET(I)) * PIP (I, KBM1) / (D(I)*DZ(KBM1)) / &
                 & 86400.
               End Do
            End If
       !
    ...
    !
         Do K = 1, KBM1
          ...
          !                  -NITRIF(I,K)-DOSZ(I,K)-DOLZ(I,K))/86400.
               DTDO (I, K) = (DOR1+DOR2-DOP1-DOP2-DDOC(I, K)-NITRIF(I, &
              & K)-DOSZ(I, K)-DOLZ(I, K)) / 86400.
          !
    ...
    !
         If (SAV_CALC) Then
            Do I = 1, NSAVCELL
              ...
              & (DOSAVW(B)+DOEPIW(B)+SEDDOSAV(B)) / (D(B)*DZ(KBM1)) / &
              & 86400.
            End Do
         End If
    ...
    !
         Do K = 2, KBM1
          ...
          !
              ...
              & K)*SIUPB(I, K)) * V2 (I, K) / (D(I)*DZ(K)*86400.)
          !
            End Do
         End Do
    !
    ...
    !
       ...
       !
            Do I = 1, MLOC
              ...
              & KBM1)-WSUNET(I)) * SIUPB (I, KBM1) / (D(I)*DZ(KBM1)) / &
              & 86400.
            End Do
         End If
    !
