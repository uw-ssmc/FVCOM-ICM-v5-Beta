...
!
      ...
      Use MOD_WQM, Only: JDAY, DLT
      Use MOD_HYDROVARS, Only: PI, ART1
!
...
!
               ...
               DICGAS (I, 1) = DICGAS (I, 1) + ((FLUXCO2/86400.0)*DLT*ART1(I)*D(I)*DZ2D(I,1))/1E6                     !air-sea gas exchange, accumulated (kmolC)
	  ...
	  !******** Sediment flux
       ...
       !                         mmolC/m^3/d     gO2/m^2/d    mmolC/gO2        1/m
			...
			ELSE
			   BENDIC=0.0_SP
			ENDIF
               DTTIC (I, KBM1) = DTTIC (I, KBM1) + BENDIC / 86400.0_SP        !- commented Laki only for debugging
...
!
    !******** Atm deposition of NO3- and NH4+ : not included yet
         If (ATMOS_LOADS) Then
            ...
            End Do
         End If
!        DTTALK = 0.0          ! Laki - only for debugging
         Return
