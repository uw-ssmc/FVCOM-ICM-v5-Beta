...
!
	 ...
	 ! 2/13/18 added TSS_GL, SSI_GL, TURB_GL, KESS_GL
  !
...
!
              ...
              !
                  ...
                  Case (.True.)
                    ...
                    & MGL),(C2_GL(I,K,16), I=1, MGL), (C2_GL(I,K,17), I=1, MGL), &
                    & (C2_GL(I, K, 18), I=1, MGL), (C2_GL(I, K, 19), I=1, MGL), &
